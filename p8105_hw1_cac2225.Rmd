...
Below is the code to save the three scatterplots produced.

```{r Saving 3 scatterplots}
ggsave("plot_sum_xandy.pdf", plot = plot_sum_xandy, height = 4, width = 6)

ggsave("plot_vnum_sum.pdf", plot = plot_vnum_sum, height = 4, width = 6)

ggsave("plot_vfac_sum.pdf", plot = plot_vfac_sum, height = 4, width = 6)
```
